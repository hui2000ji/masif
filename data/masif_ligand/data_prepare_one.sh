...
conda activate my-rdkit-env
~/anaconda3/envs/my-rdkit-env/bin/python data_preparation.01-pdb_extract_and_triangulate $1 masif_ligand
~/anaconda3/envs/my-rdkit-env/bin/python data_preparation.04c-make_protein_pyg $1
